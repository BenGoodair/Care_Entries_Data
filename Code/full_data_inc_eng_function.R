create_characteristics_data <- function(){
  ...
  leave_acc <-  read.csv(curl("https://raw.githubusercontent.com/BenGoodair/childrens_social_care_data/main/Raw_Data/LA_level/Children_Placement_Characteristics/post_2017_updated26/data/la_care_leavers_accommodation_suitability.csv"),
  ...
  leave_acctype <-  read.csv(curl("https://raw.githubusercontent.com/BenGoodair/childrens_social_care_data/main/Raw_Data/LA_level/Children_Placement_Characteristics/post_2017_updated26/data/la_care_leavers_accommodation_type.csv"),
                             colClasses = "character")%>%
    dplyr::mutate_all(~ str_replace(., ",", ""))%>% mutate(la_name = coalesce(na_if(la_name, ""), na_if(region_name, ""), country_name)) %>%
  #  dplyr::filter(geographic_level=="Local authority")%>% # keep only LAs
    dplyr::mutate(year = time_period)%>%
  ...
  leave_activity <-  read.csv(curl("https://raw.githubusercontent.com/BenGoodair/childrens_social_care_data/main/Raw_Data/LA_level/Children_Placement_Characteristics/post_2017_updated26/data/la_care_leavers_activity.csv"),
                              colClasses = "character")%>%
    dplyr::mutate_all(~ str_replace(., ",", ""))%>% mutate(la_name = coalesce(na_if(la_name, ""), na_if(region_name, ""), country_name)) %>%
  #  dplyr::filter(geographic_level=="Local authority")%>% # keep only LAs
    dplyr::mutate(year = time_period)%>%
  ...
  leave_intouch <-  read.csv(curl("https://raw.githubusercontent.com/BenGoodair/childrens_social_care_data/main/Raw_Data/LA_level/Children_Placement_Characteristics/post_2017_updated26/data/la_care_leavers_intouch.csv"),
                             colClasses = "character")%>%
    dplyr::mutate_all(~ str_replace(., ",", ""))%>% mutate(la_name = coalesce(na_if(la_name, ""), na_if(region_name, ""), country_name)) %>%
  #  dplyr::filter(geographic_level=="Local authority")%>% # keep only LAs
    dplyr::mutate(year = time_period)%>%
  ...
  leave_stayput <-  read.csv(curl("https://raw.githubusercontent.com/BenGoodair/childrens_social_care_data/main/Raw_Data/LA_level/Children_Placement_Characteristics/post_2017_updated26/data/la_care_leavers_stayput.csv"),
                             colClasses = "character")%>%
    dplyr::mutate_all(~ str_replace(., ",", ""))%>% mutate(la_name = coalesce(na_if(la_name, ""), na_if(region_name, ""), country_name)) %>%
  #  dplyr::filter(geographic_level=="Local authority")%>% # keep only LAs
    dplyr::mutate(year = time_period)%>%
  ...
  shortterm <-  read.csv(curl("https://raw.githubusercontent.com/BenGoodair/childrens_social_care_data/main/Raw_Data/LA_level/Children_Placement_Characteristics/post_2017_updated26/data/la_children_looked_after_exclusively_under_a_series_of_short_term_placements.csv"),
                         colClasses = "character")%>%
    dplyr::mutate_all(~ str_replace(., ",", ""))%>% mutate(la_name = coalesce(na_if(la_name, ""), na_if(region_name, ""), country_name)) %>%
   # dplyr::filter(geographic_level=="Local authority")%>% # keep only LAs
    dplyr::mutate(year = time_period,
  ...
  adopted_during <- read.csv(curl("https://raw.githubusercontent.com/BenGoodair/childrens_social_care_data/main/Raw_Data/LA_level/Children_Placement_Characteristics/post_2017_updated26/data/la_children_who_ceased_during_the_year_sgo_adoption.csv"),
                             colClasses = "character")%>%
    dplyr::mutate_all(~ str_replace(., ",", ""))%>% mutate(la_name = coalesce(na_if(la_name, ""), na_if(region_name, ""), country_name)) %>%
#        dplyr::filter(geographic_level=="Local authority")%>% # keep only LAs
    dplyr::mutate(year = time_period,
  ...
  ceased_during <- read.csv(curl("https://raw.githubusercontent.com/BenGoodair/childrens_social_care_data/main/Raw_Data/LA_level/Children_Placement_Characteristics/post_2017_updated26/data/la_children_who_ceased_during_the_year.csv"),
                            colClasses = "character")%>%
    dplyr::mutate_all(~ str_replace(., ",", ""))%>% mutate(la_name = coalesce(na_if(la_name, ""), na_if(region_name, ""), country_name)) %>%
#    dplyr::filter(geographic_level=="Local authority")%>% # keep only LAs
    dplyr::mutate(year = time_period)%>%
  ...
  missing <- read.csv(curl("https://raw.githubusercontent.com/BenGoodair/childrens_social_care_data/main/Raw_Data/LA_level/Children_Placement_Characteristics/post_2017_updated26/data/la_children_who_were_missing_or_away_from_placement_without_authorisation.csv"),
                      colClasses = "character")%>%
    dplyr::mutate_all(~ str_replace(., ",", ""))%>% mutate(la_name = coalesce(na_if(la_name, ""), na_if(region_name, ""), country_name)) %>%
#    dplyr::filter(geographic_level=="Local authority")%>% # keep only LAs
    dplyr::mutate(year = time_period,
  ...
  stability <- read.csv(curl("https://raw.githubusercontent.com/BenGoodair/childrens_social_care_data/main/Raw_Data/LA_level/Children_Placement_Characteristics/post_2017_updated26/data/la_cla_placement_stability.csv"),
                        colClasses = "character")%>%
    dplyr::mutate_all(~ str_replace(., ",", ""))%>% mutate(la_name = coalesce(na_if(la_name, ""), na_if(region_name, ""), country_name)) %>%
#    dplyr::filter(geographic_level=="Local authority")%>% # keep only LAs
    dplyr::mutate(year = time_period)%>%
  ...
  new_placements <- read.csv(curl("https://raw.githubusercontent.com/BenGoodair/childrens_social_care_data/main/Raw_Data/LA_level/Children_Placement_Characteristics/post_2017_updated26/data/la_cla_during_year_new_placements.csv"),
                             colClasses = "character")%>%
    dplyr::mutate_all(~ str_replace(., ",", ""))%>% mutate(la_name = coalesce(na_if(la_name, ""), na_if(region_name, ""), country_name)) %>%
#    dplyr::filter(geographic_level=="Local authority")%>% # keep only LAs
    dplyr::mutate(year = time_period)%>%
  ...
  char <- read.csv(curl("https://raw.githubusercontent.com/BenGoodair/childrens_social_care_data/main/Raw_Data/LA_level/Children_Placement_Characteristics/post_2017_updated26/data/la_cla_on_31_march_by_characteristics.csv"),
                   colClasses = "character")%>%
    dplyr::mutate_all(~ str_replace(., ",", ""))%>% mutate(la_name = coalesce(na_if(la_name, ""), na_if(region_name, ""), country_name)) %>%
#    dplyr::filter(geographic_level=="Local authority")%>% # keep only LAs
    dplyr::mutate(year = time_period)%>%
  ...
  started_during <- read.csv(curl("https://raw.githubusercontent.com/BenGoodair/childrens_social_care_data/main/Raw_Data/LA_level/Children_Placement_Characteristics/post_2017_updated26/data/la_children_who_started_to_be_looked_after_during_the_year.csv"),
                             colClasses = "character")%>%
    dplyr::mutate_all(~ str_replace(., ",", ""))%>% mutate(la_name = coalesce(na_if(la_name, ""), na_if(region_name, ""), country_name)) %>%
#    dplyr::filter(geographic_level=="Local authority")%>% # keep only LAs
    dplyr::mutate(year = time_period)%>%
  ...
  net_gain <- read.csv(curl("https://raw.githubusercontent.com/BenGoodair/childrens_social_care_data/main/Raw_Data/LA_level/Children_Placement_Characteristics/post_2017_updated26/data/la_cla_on_31_march_la_of_placement_netgain.csv"),
                       colClasses = "character")%>%
    dplyr::mutate_all(~ str_replace(., ",", ""))%>% mutate(la_name = coalesce(na_if(la_name, ""), na_if(region_name, ""), country_name)) %>%
#    dplyr::filter(geographic_level=="Local authority")%>% # keep only LAs
    dplyr::mutate(year = time_period)%>%
...
#    dplyr::filter(geographic_level=="Local authority")%>% # keep only LAs
  ...
  characteristics18 <- rbind(school_moves, net_gain, started_during, char,
                             new_placements, stability, missing, ceased_during,
                             adopted_during, shortterm, leave_acc, leave_acctype,
                             leave_activity, leave_stayput, leave_intouch)
...
#        dplyr::filter(geog_l=="LA")%>%
  ...
  characteristics <- characteristics %>%
    dplyr::mutate(subcategory = ifelse(variable=="With 3 or more placements during the year", "placement stability",
                  ...
                  variable =  ifelse(variable=="Living with the same carer for at least 2 years or are placed for adoption and their adoptive placement together with their previous placement, last for at least 2 years", "In the same placement for at least 2 years", variable)
    )
